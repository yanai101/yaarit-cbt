...
export default function CBTInfoContent() {
  return (
    <div className="cbt-content-wrapper">
      <div className="info-section">
        <p>טיפול CBT הוא טיפול רגשי קצר וממוקד, המתמקד בכאן ועכשיו ובקשיים שמלווים את האדם בחיי היום-יום.</p>
      ...
      <div className="info-section">
        ...
        <p>הטיפול אינו מתמקד בניתוח ממושך של אירועי העבר, אלא ב-<strong>מה קורה בהווה</strong> ומה ניתן לשנות כדי להרגיש טוב יותר ולהתפקד בצורה מיטבה יותר.</p>
      </div>
      ...
      <div className="info-section" style={{ 
        ...
        <p>לאפשר לאדם להבין את עצמו טוב יותר, לרכוש כלים יישומיים להתמודדות עם מצבים רגשיים מאתגרים, וליצור שינוי משמעותי ויציב באיכות החיים.</p>
      </div>
    </div>
  );
}
